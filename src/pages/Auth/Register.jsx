...
//   const { isAuthenticated, loading, error, admin } = useSelector((state) => state.auth);
...
//     }),
//     onSubmit: (values) => {
//       dispatch(registerAdmin({ name: values.name, email: values.email, password: values.password }));
//     },
//   });
...
//         {/* Form Title */}
//         <h2 className="text-3xl font-bold mb-6 text-center text-gray-800 dark:text-white">Admin Register</h2>
